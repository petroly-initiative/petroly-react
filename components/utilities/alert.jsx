    ...
    return (
      <>
        ...
        >
          ...
          <p>
            We introduce our new feature <em>Radar Register</em> UwU. To acivate
            it:
            <ol>
              <li>
              ...
              <li>
                Sign in to both Petroly and Banner/Portal, then open the
                extension in Petroly.co tab.
              </li>
              <li>
        ...
        >
          ...
          <p>
            <ul>
              ...
              <li>Radar Register is in beta version.</li>
              <li>
                If multiple sections opened for same course we'll choose one in
                random.
              </li>
            </ul>
          </p>
